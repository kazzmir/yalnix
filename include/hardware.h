...
// Linux build requires more memory, because gcc -static makes bigger
// executables.
#ifdef LINUX
#define PMEM_SIZE               2*VMEM_SIZE
#else
#define PMEM_SIZE               VMEM_SIZE
#endif
...
#define REG_PTBR0	4	/* page table base for region 0 */
#define REG_PTLR0	5	/* # of entries in region 0 table */
#define REG_PTBR1	6	/* page table base for region 1 */
#define REG_PTLR1	7	/* # of entries in region 0 table */

/* NOTE THAT VECTOR_BASE, PTBR0, and PTBR1 take VIRTUAL addresses */

/* NOTE ALSO that flushing the region 0 part of the TLB leaves    */
/* the kernel text and inital heap in the TLB                     */
