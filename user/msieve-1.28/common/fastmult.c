...
static double *make_twiddle(int32 size) {
	...
	double *w = (double *)malloc(2 * (size / 4 - 1) * sizeof(double));
...
static void make_huge_twiddle(huge_twiddle_t *table, int32 entry) {
	...
	table->large = (double *)malloc((2 << large_power) * sizeof(double));
	table->small = (double *)malloc((2 << small_power) * sizeof(double));
...
static void fht_square(int32 power, uint32 *a, int32 awords,
	...
	double *factor1 = (double *)malloc(runlength * sizeof(double));
...
static void fht_mul(int32 power, uint32 *a, int32 awords,
	...
	int32 runlength = 1 << power;
	double *factor1 = (double *)malloc(runlength * sizeof(double));
	double *factor2 = (double *)malloc(runlength * sizeof(double));
